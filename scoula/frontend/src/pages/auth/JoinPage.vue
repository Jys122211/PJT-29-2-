        ...
        <label class="field">
          ...
          <div class="password-wrapper">
            <input
              ...
              @input="onPasswordInput($event, 'password')"
              @compositionstart="onPasswordCompositionStart('password')"
              @compositionend="onPasswordCompositionEnd($event, 'password')"
            />
            <button
              type="button"
        ...
        <label class="field">
          ...
          <div class="password-wrapper">
            <input
              ...
              @input="onPasswordInput($event, 'passwordConfirm')"
              @compositionstart="onPasswordCompositionStart('passwordConfirm')"
              @compositionend="onPasswordCompositionEnd($event, 'passwordConfirm')"
            />
            <button
              type="button"
              class="toggle-password"
