...
const editMaxPayment = () => {
  tempMaxPayment.value = auth.maxMonthlyPayment ? auth.maxMonthlyPayment / 10000 : 0;
...
const saveMaxPayment = async () => {
  try {
    const actualAmount = tempMaxPayment.value * 10000;
        ...
        <div v-else class="mt-3">
          <div class="data-box rounded-3 px-3 py-3 d-flex justify-content-between align-items-center mb-3 edit-input-wrapper">
            ...
            <div class="d-flex align-items-center">
              <input type="number" class="form-control text-end border-0 bg-transparent fw-bold fs-5 p-0 me-1 edit-input" v-model="tempCreditScore" />
      ...
      <div class="card-body">
        ...
        <div v-else class="mt-3">
          <div class="data-box rounded-3 px-3 py-3 d-flex justify-content-between align-items-center mb-3 edit-input-wrapper">
            <span class="text-secondary fw-semibold">현재 설정 금액</span>
            <div class="d-flex align-items-center">
              <input type="number" class="form-control text-end border-0 bg-transparent fw-bold fs-5 p-0 me-1 edit-input" v-model="tempMaxPayment" />
              <span class="fw-bold fs-5">만원</span>
            </div>
          </div>
          <div class="d-flex gap-2">
